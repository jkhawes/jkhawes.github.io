...
<!-- ────────────────────────────────────────────────
     PROJECT CARD TEMPLATE (copy and repeat)
     ──────────────────────────────────────────────── -->
<!--
<div class="hes-project">
  <div class="hes-project__header">
    <span class="hes-project__status hes-project__status--[active|complete]">[Active | Complete]</span>
    <h3 class="hes-project__title">[Project title]</h3>
  </div>
  <p class="hes-project__desc">[1–3 sentence description of the project.]</p>
...
.hes-project__status--active {
  background: #e6f4ed;
  color: #2a6e49;
}
.hes-project__status--complete {
  background: #f0f0f0;
  color: #666;
}
.hes-project__title {
